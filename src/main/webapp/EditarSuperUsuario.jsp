<%-- 
    Document   : EditarSuperUsuario
    Created on : 16/04/2023, 11:50:45 PM
    Author     : netor
--%>
        ...
        <section class="form-Alumnos">
            ...
            <form name="Usuario" method="POST" action="Usuario">
                ...
                <div class="texto">  <br>
                    ...
                    <br><input class="controls" type="number" name="Codtxt" value="<%= u.getCod()%>" placeholder="Ingrese su Codigo" min="100000000" max="999999999">
                ...
                <input  type="submit" name="ActualizarSuper" value="Actualizar" class="botons">
